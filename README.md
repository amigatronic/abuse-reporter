...
- **v1.1.1** — added Base64/Quoted-Printable obfuscation detection (spammers hide homoglyphs in encoded headers), increased scoring for mixed-character-set attacks, improved RDAP bootstrap matching.
